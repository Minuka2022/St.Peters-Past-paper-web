        ...
        <div class="col-md-3">
            <div class="box">
                <div class="our-services settings custom-border" style="padding-top:80px; ">
                    ...
                    <h4 style="font-weight:bold; font-size:36px;" >Grade 6</h4>
        ...
        <div class="col-md-3">
            <div class="box">
                 <div class="our-services settings custom-border" style="padding-top:80px; ">
                    ...
                    <h4 style="font-weight:bold; font-size:36px;" >Grade 7</h4>
        ...
        <div class="col-md-3">
            <div class="box">
                 <div class="our-services settings custom-border" style="padding-top:80px; ">
                    ...
                    <h4 style="font-weight:bold; font-size:36px;" >Grade 8</h4>
        ...
        <div class="col-md-3">
            <div class="box">
                 <div class="our-services settings custom-border" style="padding-top:80px; ">
                    ...
                    <h4 style="font-weight:bold; font-size:36px;" >Grade 9</h4>
        ...
        <div class="col-md-3">
            <div class="box">
                 <div class="our-services settings custom-border" style="padding-top:80px; ">
                    ...
                    <h4  style="font-weight:bold; font-size:36px;" >Grade 10</h4>
        ...
        <div class="col-md-3">
            <div class="box">
                 <div class="our-services settings custom-border" style="padding-top:80px; ">
                    ...
                    <h4 style="font-weight:bold; font-size:36px;" >Grade 11</h4>
        ...
        <div class="col-md-3">
            <div class="box">
                 <div class="our-services settings custom-border" style="padding-top:80px; ">   
                    ...
                    <h4  style="font-weight:bold; font-size:36px;" >Grade 12</h4>
